...
import com.dsource.idc.jellowboard.makemyboard.Board;
...
public class BoardDatabase extends SQLiteOpenHelper {
    ...
    public void addBoardToDatabase(Board board) {
    ...
    public Board getBoardById(String boardID) {
        ...
        try {
            ...
            Log.d("Board Query Error",e.getMessage());
        } finally {
            // Must close cursor and db now that we are done with it.
            if (cursor != null)
                cursor.close();
    ...
    public void updateBoardIntoDatabase(Board board) {
