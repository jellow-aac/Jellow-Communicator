...
public class CircularImage1 extends ImageView {
    ...
    public CircularImage1(final Context context) {
        this(context, null);
    }

    public CircularImage1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircularImage1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawShadow(float shadowRadius, int shadowColor) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.HONEYCOMB) {
            setLayerType(LAYER_TYPE_NONE, paintBorder);
        }
        //shadowRadius = 0;
