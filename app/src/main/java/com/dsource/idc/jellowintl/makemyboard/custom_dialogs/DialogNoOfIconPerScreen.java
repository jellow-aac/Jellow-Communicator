package com.dsource.idc.jellowintl.makemyboard.custom_dialogs;
    ...
    private void setUpGridDialog(int gridSize) {
        ...
        switch (gridSize){
            case GlobalConstants.ONE_ICON_PER_SCREEN:
                ((FrameLayout)findViewById(R.id.fl_one_icon)).setForeground(
                        getResources().getDrawable(R.drawable.border_number_of_icons_per_screen));
                break;
            case GlobalConstants.TWO_ICONS_PER_SCREEN:
                ((FrameLayout)findViewById(R.id.fl_two_icon)).setForeground(
                        getResources().getDrawable(R.drawable.border_number_of_icons_per_screen));
                break;
            case GlobalConstants.THREE_ICONS_PER_SCREEN:
                ((FrameLayout)findViewById(R.id.fl_three_icon)).setForeground(
                        getResources().getDrawable(R.drawable.border_number_of_icons_per_screen));
                break;
            case GlobalConstants.FOUR_ICONS_PER_SCREEN:
                ((FrameLayout)findViewById(R.id.fl_four_icon)).setForeground(
                        getResources().getDrawable(R.drawable.border_number_of_icons_per_screen));
                break;
            case GlobalConstants.NINE_ICONS_PER_SCREEN:
                ((FrameLayout)findViewById(R.id.fl_nine_icon)).setForeground(
                        getResources().getDrawable(R.drawable.border_number_of_icons_per_screen));
                break;
        }
    }
