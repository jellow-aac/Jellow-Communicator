...
public class JellowFirebaseMessageService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if(!isRemoteMessageIntended(remoteMessage)){
            return;
        }
        buildNotification(remoteMessage);
        NotificationCompat.Builder builder = buildNotification(remoteMessage);
    ...
    private boolean isRemoteMessageIntended(RemoteMessage remoteMessage) {
        return remoteMessage.getData().get("packageName").equals(getPackageName()) &&
            remoteMessage.getData().get("versionCode").equals(String.valueOf(BuildConfig.VERSION_CODE));
    }

    public NotificationCompat.Builder buildNotification(RemoteMessage remoteMessage) {
