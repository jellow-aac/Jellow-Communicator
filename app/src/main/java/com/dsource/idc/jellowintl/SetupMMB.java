...
/* TODO Language Independent
    ...
    private void createDatabase() {
        VerbiageDatabaseHelper databaseHelper = new VerbiageDatabaseHelper(this,new DataBaseHelper(this).getWritableDatabase());
    ...
    private void createIconDatabase() {
        IconDatabase iconDatabase = new IconDatabase(this,new DataBaseHelper(this).getWritableDatabase());
